...
export default function MainPage() {
  ...
  <Container>
    ...
    <p id="jumboText">
     ...
     During my studies with web development, i've learned to love both Frontend/Backend Development equally. I have natural curiosity for Technology and look forward to continuing my studies day after day.
